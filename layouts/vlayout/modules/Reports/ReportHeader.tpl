        ...
        <div class="row-fluid reportsDetailHeader">
            ...
            <div class="row-fluid">
                ...
                {foreach key=MODULE_LABEL item=SECONDARY_MODULE_RECORD_STRUCTURE from=$SECONDARY_MODULE_RECORD_STRUCTURES}
                    ...
                    {/foreach}
                {/foreach}
                {include file=''|@vtemplate_path RECORD_STRUCTURE=$RECORD_STRUCTURE ADVANCE_CRITERIA=$SELECTED_ADVANCED_FILTER_FIELDS COLUMNNAME_API=getReportFilterColumnName}
                <div class="row-fluid">
